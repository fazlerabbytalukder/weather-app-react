...
import WindIocn from '../../assets/icons/wind.svg';
...
export default function WeatherCondition() {
    ...
    return (
        <div>
            <p className="text-sm lg:text-lg font-bold uppercase mb-8">The Climate is <ul>{climate}</ul></p>
